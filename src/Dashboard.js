...
function Dashboard() {
  ...
  const handleHide = () => {
    $('.hideCta .hideButton').toggleClass('hide');
    $('.hideCta .showButton').toggleClass('showCta');
    $('.selectedCommitteeSection').toggleClass('hide');
    $('#spaceTag').toggleClass('hide');
  }

  const handlesubNavClick = (e) => {
    console.log(e.target, 'handlesubNavClick');
    if(e.currentTarget.classList.contains('selectedNav')) {
      e.currentTarget.classList.remove('selectedNav');
    } else {
      e.currentTarget.classList.add('selectedNav');
    }
  };
  ...
  return (
    <div className="dashboard">
      ...
      <div className="dropdown maindropdown">
      ...
      <div className="subNav">
        <div className="committee" onClick={ handlesubNavClick }>
          <p>Committees</p></div>
        <div className="details" onClick={ handlesubNavClick }>
          <p>Details</p></div>
        <div className="summary" onClick={ handlesubNavClick }>
          <p>Summary</p></div>
      </div>
      ...
      <div className="modal">
        ...
        <div className="selectedCommitte">
          <div className="demo">
            ...
            <div className="hideCta">
              <button className='hideButton' onClick={ handleHide }>Hide</button>
              <button className='showButton'onClick={ handleHide }>Show</button>
            </div>
          </div>
          <hr id="spaceTag"/>
          <div className="selectedCommitteeSection" >
